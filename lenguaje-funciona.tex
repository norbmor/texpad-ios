...
\subsection{La noción de nivel de representación}
	...
	El soldado llegó
	\begin{exe}
	  \ex Análisis fonológico: \textipa{[elsolda\dh oJeGo]}
	  \ex Análisis silábico: $[_\sigma$\textipa{el}$]$$[_\sigma$\textipa{sol}$]$$[_\sigma$\textipa{da}$]$$[_\sigma$\textipa{Do}$]$$[_\sigma$\textipa{Je}$]$$[_\sigma$\textipa{Go}$]$
	    \ex Análisis morfológico:\\ \textipa{el}[\textsc{det. masc. sing
	    3p}]\\
